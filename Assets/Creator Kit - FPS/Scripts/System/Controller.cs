...
public class Controller : MonoBehaviour
{
    ...
    int m_CurrentWeapon;
    public bool gunPickedUp=true,riflePickedUp=false,grenadePickedUp=false;
    ...
    void PickupWeapon(Weapon prefab)
    {
        ...
        else
        {
            ...
            gameObject.GetComponent<PlayerStats>().weaponPrefabs.Add(w);
            w.PickedUp(this);
    ...
    public void ChangeAmmo(int ammoType, int amount)
    {
        ...
        m_AmmoInventory[ammoType] = Mathf.Clamp(m_AmmoInventory[ammoType] + amount, 0, 1999);
